...
class BaseEntity(object):
    ...
    def __init__(self, file_dir, file_id, feature_type, phone_type="PHN39", wav_sampling_rate=8000):
    ...
    def downSampling(self, sampling_type="median"):
        if self.phone_position == None and sampling_type != "uniform" and sampling_type != "uniform_mean":
    ...
    def meanSampling(self):
        ...
        for i in range(len(self.phone_position)):
            ...
            mean_feature = self.feature[s_index:e_index, :].mean(0).reshape(1, dim)
